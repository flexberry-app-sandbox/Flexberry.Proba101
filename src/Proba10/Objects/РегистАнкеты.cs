...
namespace IIS.Proba10
{
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba10.DetailArrayOfТЧРегистАнкеты fТЧРегистАнкеты;
        ...
        public virtual IIS.Proba10.DetailArrayOfТЧРегистАнкеты ТЧРегистАнкеты
        {
            get
            {
                ...
                {
                    this.fТЧРегистАнкеты = new IIS.Proba10.DetailArrayOfТЧРегистАнкеты(this);
                }
                IIS.Proba10.DetailArrayOfТЧРегистАнкеты result = this.fТЧРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba10.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba10.РегистАнкеты));
                }
            }
        }
    }

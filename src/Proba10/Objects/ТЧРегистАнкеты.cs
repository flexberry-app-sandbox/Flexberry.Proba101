...
namespace IIS.Proba10
{
    ...
    public class ТЧРегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba10.Должности fДолжности;
        
        private IIS.Proba10.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Proba10.Должности Должности
        {
            get
            {
                ...
                IIS.Proba10.Должности result = this.fДолжности;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba10.РегистАнкеты.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        public virtual IIS.Proba10.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba10.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегистАнкетыE", typeof(IIS.Proba10.ТЧРегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТЧРегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегистАнкетыL", typeof(IIS.Proba10.ТЧРегистАнкеты));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегистАнкеты : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba10.DetailArrayOfТЧРегистАнкеты members)

        // *** End programmer edit section *** (IIS.Proba10.DetailArrayOfТЧРегистАнкеты members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегистАнкеты(IIS.Proba10.РегистАнкеты fРегистАнкеты) : 
                base(typeof(ТЧРегистАнкеты), ((ICSSoft.STORMNET.DataObject)(fРегистАнкеты)))
        {
        }
        
        public IIS.Proba10.ТЧРегистАнкеты this[int index]
        {
            get
            {
                return ((IIS.Proba10.ТЧРегистАнкеты)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba10.ТЧРегистАнкеты dataobject)
        {

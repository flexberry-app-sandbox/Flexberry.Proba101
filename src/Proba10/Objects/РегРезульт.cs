...
namespace IIS.Proba10
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba10.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba10.Сотрудники fСотрудники;
        ...
        public virtual IIS.Proba10.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba10.ИтогСобес result = this.fИтогСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba10.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba10.Сотрудники result = this.fСотрудники;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba10.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba10.РегРезульт));
                }
            }
        }
    }

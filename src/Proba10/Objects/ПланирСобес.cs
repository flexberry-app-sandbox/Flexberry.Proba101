...
namespace IIS.Proba10
{
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba10.Организация fОрганизация;
        
        private IIS.Proba10.DetailArrayOfТЧПланирСобес fТЧПланирСобес;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proba10.Организация Организация
        {
            get
            {
                ...
                IIS.Proba10.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Proba10.DetailArrayOfТЧПланирСобес ТЧПланирСобес
        {
            get
            {
                ...
                {
                    this.fТЧПланирСобес = new IIS.Proba10.DetailArrayOfТЧПланирСобес(this);
                }
                IIS.Proba10.DetailArrayOfТЧПланирСобес result = this.fТЧПланирСобес;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba10.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba10.ПланирСобес));
                }
            }
        }
    }
